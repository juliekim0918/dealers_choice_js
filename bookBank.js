...
Illuminating the moving, at times harrowing stories of the people doing society's dirty work, and incisively examining the structures of power and complicity that shape their lives, Press reveals fundamental truths about the moral dimensions of work, and the hidden costs of inequality in America.`,
  ...
  },
  {
    ...
    summary: `Return to New York City and Minneapolis in 1988, at the peak of the AIDS crisis, in this stunning novel of relationships and surviving heartbreaking loss. Published on the 40th anniversary of the disease's first reported cases, this story is both a tribute to a generation lost to the pandemic as well as a powerful exploration of heartbreak, recovery, and how love can defy grief.
...
`,
  ...
  },
  {
    ...
    summary: `From the critically acclaimed author of Shelter, an unflinching portrayal of a woman trying to come to terms with the ghosts of her past and the tortured realities of a deeply divided America
...
const findBook = (id) => {
    const book = books.find((book) => book.id === (id * 1))
    return {...book}
}
